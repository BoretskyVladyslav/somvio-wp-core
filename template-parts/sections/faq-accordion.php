<?php
/**
 * FAQ accordion section — Figma 300:2375.
 *
 * All items start closed (including the first). Toggle via accordion.js + ARIA.
 *
...
?>
<section class="faq" aria-label="<?php esc_attr_e( 'Frequently Asked Questions', 'somvio' ); ?>">
	<div class="faq__inner">
		<div class="faq__accordion" data-accordion>
			<?php foreach ( $somvio_faq_items as $index => $item ) : ?>
				...
				?>
				<div
					class="faq__item reveal-on-scroll"
