...
function somvio_acf_addon_key_choices() {
	return array(
		...
		'kitchen-cupboards'     => __( 'Inside Kitchen Cupboards (must be empty)', 'somvio' ),
		'washing-machine'       => __( 'Inside Washing Machine', 'somvio' ),
		'dishwasher'            => __( 'Inside Dishwasher', 'somvio' ),
		'tumble-dryer'          => __( 'Inside Tumble Dryer', 'somvio' ),
